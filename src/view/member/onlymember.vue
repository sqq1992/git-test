<template>
	<div class="m-content">
		<div class="m-content-main main_height fontClass" v-loading="loadingPage">
			<div class="clearfix">
				<el-button type="primary" size="small" class="m_b10 f-fr" @click="createNew">新建会员专享券</el-button>
			</div>
			            ...
			            <el-row>
			                <el-col>
			                	...
			                	<div v-else>
			                		...
			                		<el-button v-else type="text" @click="endNow(scope.row)" class="ml_5">立即结束</el-button>
			                	</div>
			                </el-col>
			            </el-row>
			        </template>
